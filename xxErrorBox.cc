// $Id: xxErrorBox.cc 2641 2007-09-02 21:31:02Z flaterco $
...
xxErrorBox::xxErrorBox (const xxWidget &shell,
  ...
  if (_fatality == Error::fatal) {
    ...
    XtCreateManagedWidget ("", labelWidgetClass, container->widget(), args, 5);
  }

  Widget labelWidget = XtCreateManagedWidget (errorMessage.aschar(),
...

  {
    ...
    if (_fatality == Error::fatal)
      ...
      buttonLabel = "Oops";
    Widget buttonWidget = XtCreateManagedWidget (buttonLabel,
