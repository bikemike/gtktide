// $Id: xxClock.cc 2832 2007-12-01 01:05:01Z flaterco $
...
void xxClock::toggleButtons() {
  ...
  Global::root->newClock (_station.release(), bs);
}
...
void xxClock::redrawIcon() {
  ...
  XDrawString (xxX::display, clockIcon, xxX::iconTextGC,
	       c-(xxX::stringWidth(xxX::tinyFontStruct, hicap)/2), 7,
	       hicap, strlen(hicap));
  XDrawString (xxX::display, clockIcon, xxX::iconTextGC,
	       c-(xxX::stringWidth(xxX::tinyFontStruct, locap)/2),
