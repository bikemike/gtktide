// $Id: xxTextMode.cc 2641 2007-09-02 21:31:02Z flaterco $
...
void xxTextMode::save () {
  if (_mode == Mode::plain)
    (void) new xxFilename (*popup, *this, "tides.txt");
  else
...
void xxTextMode::construct () {
...

  {
    ...
    Widget labelWidget = XtCreateManagedWidget (_station->name.aschar(),
    ...
    Arg labelArgs[8] =  {
      {XtNbackground, (XtArgVal)xxX::pixels[Colors::background]},
      {XtNforeground, (XtArgVal)xxX::pixels[Colors::foreground]},
      {XtNfromVert, (XtArgVal)nameLabel->widget()},
      {XtNleft, (XtArgVal)XawChainLeft},
    ...
    Arg buttonArgs[8] =  {
      ...
      {XtNforeground, (XtArgVal)xxX::pixels[Colors::foreground]},
      {XtNfromVert, (XtArgVal)label->widget()},
      {XtNfromHoriz, (XtArgVal)backwardButton->widget()},
      {XtNleft, (XtArgVal)XawChainLeft},
      {XtNright, (XtArgVal)XawChainLeft},
      {XtNtop, (XtArgVal)XawChainBottom},
      {XtNbottom, (XtArgVal)XawChainBottom}
